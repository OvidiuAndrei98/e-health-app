    ...
    return (
        <>
            ...
            <div className="dashboard-container">
                <div className="dashboard-section f-1">
                ...
                <div className="dashboard-section d-flex collumn f-1">
                    ...
                    <Button  style={{background:"#F27457"}} variant="contained" sx={{borderRadius:"5px", padding:"30px 5px", height:"0", marginTop:"20px", float:"right", marginBottom:"10px"}}>Add Patient</Button>        
